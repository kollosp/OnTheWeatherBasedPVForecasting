...
class create_lstm_keras_model:
    def __init__(self, input_shape, output_shape, hidded_layers=(20,), optimizer='adam',
                     kernel_initializer='glorot_uniform'):
        self.model = Sequential()
        self.model.add(Input(shape=input_shape))
        for hidded_layer in hidded_layers:
            self.model.add(LSTM(hidded_layer,return_sequences=True, kernel_initializer=kernel_initializer))
        self.model.add(Flatten())
        self.model.add(Dense(output_shape,kernel_initializer=kernel_initializer))
        self.model.compile(loss='mean_absolute_error',optimizer=optimizer, metrics=['mean_squared_error'], steps_per_execution=10)
